...
const DESIGNS = [
     { id: 1, name: 'Classic Teal Straight Trouser', img: '/images/Customer/Tailor/2.png' },
    { id: 2, name: 'Peplum Blouse', img: '/images/Customer/Tailor/1.png' },
    { id: 3, name: 'Jacket', img: '/images/Customer/Tailor/9.png' },
    { id: 4, name: 'Frock', img: '/images/Customer/Tailor/8.png' },
];

export default function CustomerUploadMeasurement({ onNavigate }) {
        ...
        <div className="min-h-screen bg-white dark:bg-black flex font-sans text-neutral-900 dark:text-neutral-50 transition-colors duration-300">
            ...
            <main className="flex-1 flex flex-col h-screen overflow-hidden">
                ...
                <div className="flex-1 overflow-hidden flex">
                    ...
                    {/* Right Panel: Measurement Form */}
                    <div className="w-96 bg-[#EEEEEE] dark:bg-white/5 border-l border-neutral-100 dark:border-white/10 p-8 flex flex-col shadow-xl z-10 animate-in slide-in-from-right overflow-y-auto transition-colors">
                        <h2 className="text-lg font-bold text-neutral-900 dark:text-white mb-8 self-center">Add Your Measurement</h2>

                        <div className="space-y-6 flex-1">
                            {['Height', 'Chest/Bust', 'Waist', 'Hips', 'Shoulder', 'Arm Length'].map((label) => (
                                <div key={label} className="flex items-center justify-between border-b border-black dark:border-neutral-700 pb-1">
                                    <label className="text-xs font-bold text-neutral-900 dark:text-white">{label}</label>
                                    <span className="text-xs text-neutral-500 dark:text-neutral-400">cm</span>
                                </div>
                            ))}
                        </div>
