...
// Icons wrapper for social media
...
export default function CustomerTailorProfile({ onNavigate }) {
            ...
            <main className="flex-1 flex flex-col h-screen overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto p-6 lg:p-10 scrollbar-hide">
                    ...
                    <div className="bg-white dark:bg-white/5 rounded-[40px] border border-neutral-100 dark:border-white/10 shadow-sm overflow-hidden mb-8 relative transition-colors">
                        ...
                        <div className="px-10 pb-8 pt-0 relative">
                            ...
                            <div className="absolute -top-16 left-10">
                                <div className="w-32 h-32 rounded-full p-1 bg-white dark:bg-neutral-800 shadow-md">
                                    <div className="w-full h-full rounded-full overflow-hidden relative border-4 border-neutral-50 dark:border-neutral-700">
                                        <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=256&q=80" alt="img" className="w-full h-full object-cover" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-20 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
                                <div className="md:ml-36">
                                    <h1 className="text-4xl font-bold text-neutral-900 dark:text-white mb-1">Harriet King</h1>
                                    <div className="flex items-center gap-2">
                                        <span className="px-3 py-0.5 rounded-full bg-black dark:bg-white text-xs font-bold text-white dark:text-black">Recommended</span>
                                        <p className="text-neutral-500 dark:text-neutral-400 font-medium text-lg flex items-center gap-2">
                                            <Scissors size={18} className="text-neutral-400" />
                                            Master Tailor - Ladies Wear
                                        </p>
                                    </div>
                                </div>
                                <div className="flex flex-col items-end gap-4">
                                    ...
                                    <button
                                        ...
                                        className="bg-black dark:bg-white text-white dark:text-black font-bold py-3 px-8 rounded-xl shadow-lg hover:bg-neutral-800 dark:hover:bg-neutral-200 transition-all flex items-center gap-2"
                                    >
                                        <ShoppingBag size={18} />
                                        Place Custom Order
                                    </button>
                    ...
                    <div className="flex bg-[#F3F4F6] dark:bg-neutral-800 p-1.5 rounded-full mb-8 max-w-4xl mx-auto shadow-inner transition-colors">
                        {['Designs', 'Profile', 'Performance'].map((tab) => (
                            <button
                                key={tab}
                            ...
                            <div className="animate-fade-in-up">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                                    ...
                                    <div>
                                        ...
                                        <div className="bg-[#F9FAFB] dark:bg-neutral-800 border border-neutral-100 dark:border-neutral-700 rounded-xl p-4 text-sm font-bold text-neutral-900 dark:text-white">
                                            harriet.k@studio.com
                                        </div>
                                    </div>
                                    <div>
                                        <label className="block text-sm font-semibold text-neutral-500 dark:text-neutral-400 mb-2">Experience</label>
                                        <div className="bg-[#F9FAFB] dark:bg-neutral-800 border border-neutral-100 dark:border-neutral-700 rounded-xl p-4 text-sm font-bold text-neutral-900 dark:text-white">
                                            15+ Years
                                        </div>
                                    </div>
                                    <div>
                                        <label className="block text-sm font-semibold text-neutral-500 dark:text-neutral-400 mb-2">Specialty</label>
                                        <div className="bg-[#F9FAFB] dark:bg-neutral-800 border border-neutral-100 dark:border-neutral-700 rounded-xl p-4 text-sm font-bold text-neutral-900 dark:text-white">
                                ...
                                <div>
                                    ...
                                    <div className="bg-[#F9FAFB] dark:bg-neutral-800 border border-neutral-100 dark:border-neutral-700 rounded-xl p-4 text-sm font-medium text-neutral-700 dark:text-neutral-300 leading-relaxed">
                                        Award-winning tailor specializing in intricate designs and perfect fits. With a background in high fashion and traditional stitching, Harriet brings a unique touch to every garment she creates.
                                    </div>
                                </div>
                            </div>
                        )}
                        ...
                        {activeTab === 'Performance' && (
                            <div className="animate-fade-in-up">
                                <div className="flex justify-between items-center mb-8">
                                    <h3 className="text-xl font-bold text-neutral-900 dark:text-white">Orders Finished</h3>
                        ...
                        {activeTab === 'Designs' && (
                            <div className="animate-fade-in-up">
                                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                                    {[
                                        { id: 1, title: 'Summer Floral', img: 'https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?auto=format&fit=crop&w=600&q=80', price: '$85' },
                                        { id: 2, title: 'Evening Red', img: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?auto=format&fit=crop&w=600&q=80', price: '$120' },
                                        { id: 3, title: 'Bridal White', img: 'https://images.unsplash.com/photo-1585487000160-6ebcfceb0d03?auto=format&fit=crop&w=600&q=80', price: '$200' },
                                        { id: 4, title: 'Green Velvet', img: 'https://images.unsplash.com/photo-1566174053879-31528523f8ae?auto=format&fit=crop&w=600&q=80', price: '$150' },
                                    ].map((design) => (
                                        <div key={design.id} className="rounded-2xl overflow-hidden bg-neutral-50 dark:bg-neutral-800 border border-neutral-100 dark:border-neutral-700 group relative transition-colors">
                                            <div className="aspect-[3/4] overflow-hidden">
                                                <img src={design.img} alt={design.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
                                            </div>
                                            <div className="p-4 bg-white dark:bg-white/5 relative z-10 transition-colors">
                                                <h4 className="font-bold text-neutral-900 dark:text-white mb-1">{design.title}</h4>
                                                <p className="text-neutral-500 dark:text-neutral-400 text-xs font-bold mb-3">{design.price}</p>
                                                <button
                                                    onClick={() => onNavigate('customer-order-details')}
                                                    className="w-full bg-black dark:bg-white text-white dark:text-black text-xs font-bold py-2.5 rounded-lg hover:bg-neutral-800 dark:hover:bg-neutral-200 transition-colors"
                                                >
                                                    Buy Now
                                                </button>
                                            </div>
