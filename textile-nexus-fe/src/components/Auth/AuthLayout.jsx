...
export default function AuthLayout({ children }) {
    return (
        <div className="min-h-screen w-full bg-[#111111] flex items-center justify-center p-4 relative overflow-hidden font-sans">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
                ...
                <div className="absolute bottom-[-10%] right-[-10%] w-[50vw] h-[50vw] bg-white/5 rounded-full blur-[100px]" />
            </div>

            {/* Logo */}
            <div className="absolute top-8 left-8 flex items-center gap-3 z-50">
                <img src="/images/logo.png" alt="Logo" className="w-10 h-10 object-contain bg-white rounded-lg p-1" />
