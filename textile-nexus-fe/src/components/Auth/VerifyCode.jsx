    ...
    return (
        <AuthLayout>
            <div className="bg-white dark:bg-white/5 dark:backdrop-blur-xl dark:border dark:border-white/10 rounded-3xl p-8 md:p-10 shadow-2xl animate-fade-in-up transition-colors">
                ...
                <h2 className="text-3xl font-bold text-neutral-900 dark:text-white mb-2">Verify code</h2>
                <p className="text-neutral-500 dark:text-neutral-400 mb-8 text-sm">An authentication code has been sent to your email.</p>
