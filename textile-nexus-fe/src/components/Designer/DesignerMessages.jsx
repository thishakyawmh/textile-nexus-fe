        ...
        <div className="min-h-screen bg-[#fff] flex font-sans text-neutral-900">
            ...
            <main className="flex-1 flex flex-col h-screen overflow-hidden">
                ...
                <div className="flex-1 flex overflow-hidden p-6 lg:px-10 lg:pb-10 lg:pt-6 gap-6">
                    ...
                    <div className="w-64 bg-white rounded-2xl border border-neutral-100 hidden lg:flex flex-col shrink-0 h-full overflow-y-auto scrollbar-hide">
                        <div className="p-6">
                            <button className="w-full bg-[#111] text-white py-3 rounded-xl font-bold text-sm flex items-center justify-center gap-2 hover:bg-black transition-colors mb-6 shadow-lg">
                                <Plus size={16} /> Compose
                            </button>

                            <h3 className="text-xs font-bold text-neutral-900 mb-4 px-2">My Email</h3>
                                ...
                                {EMAIL_FOLDERS.map(folder => (
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            activeFolder === folder.id ? "bg-neutral-100 text-neutral-900" : "text-neutral-500 hover:bg-neutral-50 hover:text-neutral-800"
                                        )}
                                    >
                            ...
                            <h3 className="text-xs font-bold text-neutral-900 mb-4 px-2">Label</h3>
                            <div className="space-y-1 mb-4">
                                {LABELS.map(label => (
                                    <button
                                        key={label.id}
                                        className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-neutral-500 hover:bg-neutral-50 hover:text-neutral-800 transition-colors"
                                    >
                                        <div className={cn("w-3 h-3 rounded border-2", label.color ? label.color.replace('bg-', 'border-').replace('400', '500') : "border-neutral-300")} />
                                        {/* Design shows outline square. Let's replicate properly. */}
                                ...
                                <button className="w-full flex items-center gap-3 px-3 py-2 text-sm text-neutral-400 hover:text-neutral-600 mt-2">
                    ...
                    <div className="flex-1 bg-white rounded-2xl border border-neutral-100 flex flex-col h-full overflow-hidden shadow-sm relative">
                        {/* Message Header */}
                        <div className="h-16 border-b border-neutral-100 flex items-center justify-between px-6 shrink-0">
                            <div className="flex items-center gap-3">
                                <button className="lg:hidden mr-2 p-1 bg-neutral-100 rounded">
                                    <Menu size={16} />
                                </button>
                                <h2 className="font-bold text-neutral-900">Minerva Barnett</h2>
                                <span className="bg-purple-100 text-purple-600 text-[10px] px-2 py-0.5 rounded font-bold">Friends</span>
                            </div>
                            <div className="flex items-center gap-2 text-neutral-400">
                                <button className="p-2 hover:bg-neutral-50 rounded-lg transition-colors"><Printer size={18} /></button>
                                <button className="p-2 hover:bg-neutral-50 rounded-lg transition-colors"><Star size={18} /></button>
                                <button className="p-2 hover:bg-neutral-50 rounded-lg transition-colors"><Trash2 size={18} /></button>
                            </div>
                        </div>
                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-8 bg-[#FAFAFA]">
                            ...
                            <div className="flex gap-4">
                                ...
                                <div className="max-w-[80%]">
                                    <div className="bg-[#F3F4F6] p-4 rounded-r-2xl rounded-bl-2xl text-sm text-neutral-600 leading-relaxed mb-1 shadow-sm">
                            ...
                            <div className="flex flex-row-reverse gap-4">
                                {/* No avatar for self usually, or minimal */}
                                <div className="max-w-[80%]">
                                    <div className="bg-black text-white p-4 rounded-l-2xl rounded-br-2xl text-sm leading-relaxed mb-1 shadow-md">
                        ...
                        <div className="p-4 border-t border-neutral-100 bg-white">
                            <div className="flex items-center gap-4 bg-white px-2">
                                <button className="text-neutral-400 hover:text-neutral-600"><Mic size={20} /></button>
                                <input
                                    type="text"
                                    placeholder="Write massage"
                                    className="flex-1 bg-transparent border-none outline-none text-sm placeholder:text-neutral-400 h-10"
                                />
                                <button className="text-neutral-400 hover:text-neutral-600"><Paperclip size={20} /></button>
                                <button className="text-neutral-400 hover:text-neutral-600"><FileText size={20} /></button>
                                <button className="bg-black text-white px-4 py-2 rounded-lg flex items-center gap-2 text-xs font-bold hover:bg-neutral-800 transition-colors">
