...
export default function SupplierSidebar({ activePage, onNavigate, sidebarOpen, setSidebarOpen }) {
        ...
        <>
            ...
            {showLogoutConfirm && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-white dark:bg-white/5 rounded-3xl p-8 max-w-sm w-full mx-4 shadow-2xl scale-100 animate-in zoom-in-95 duration-200 border border-neutral-100 dark:border-white/10">
                        <div className="flex flex-col items-center text-center">
                            <div className="w-16 h-16 bg-rose-100 dark:bg-rose-900/20 text-rose-500 rounded-2xl flex items-center justify-center mb-6">
                                <LogOut size={32} />
                            </div>
