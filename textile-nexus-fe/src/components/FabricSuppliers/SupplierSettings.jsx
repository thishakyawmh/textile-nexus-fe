...
export default function SupplierSettings({ onNavigate }) {
                    ...
                    <div className="bg-white dark:bg-white/5 rounded-3xl p-10 lg:p-16 border border-neutral-100 dark:border-white/10 shadow-sm flex flex-col items-center transition-colors">
                        ...
                        <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
                            ...
                            <div className="flex flex-col gap-2">
                                <label className="text-xs font-semibold text-neutral-500 dark:text-neutral-400">Suppliers Name</label>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <input type="text" defaultValue="Bright web is a hybrid dashboard" className="w-full px-5 py-3.5 bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-md text-sm font-semibold text-neutral-800 dark:text-neutral-200 outline-none focus:border-black dark:focus:border-neutral-500 transition-colors" />
                            </div>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <input type="text" defaultValue="CEO" className="w-full px-5 py-3.5 bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-md text-sm font-semibold text-neutral-800 dark:text-neutral-200 outline-none focus:border-black dark:focus:border-neutral-500 transition-colors" />
                            </div>
