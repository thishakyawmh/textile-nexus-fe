...
const MENU_ITEMS = [
    ...
    { id: 'fabric-market', label: 'Fabric Market', icon: ShoppingBag },
    { id: 'design-explore', label: 'Design Explore', icon: ScanSearch },
    { id: 'ai-capacity', label: 'AI Capacity Planner', icon: LineChart },
    { id: 'messages', label: 'Messages', icon: MessageSquare },
    { id: 'settings', label: 'Settings', icon: Settings },
];

export default function FactorySidebar({ activePage = 'dashboard', sidebarOpen, setSidebarOpen, onNavigate }) {
